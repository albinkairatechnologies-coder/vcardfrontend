...
export default function Login() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-indigo-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }} />
      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/60 text-sm mt-1">Sign in to your SmartCard account</p>
        </div>
